...
public class ModoJuego extends javax.swing.JFrame {
    ...
    public ModoJuego(Player player, Main main) {
        initComponents();
        this.player = player;
        this.main = main;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        player.setModo(true);
        JOptionPane.showMessageDialog(null, "Modo de juego actual: Manual");
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        player.setModo(false);
        JOptionPane.showMessageDialog(null, "Modo de juego actual: Random");
